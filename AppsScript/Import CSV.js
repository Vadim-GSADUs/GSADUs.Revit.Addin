// ────────── CONFIG ──────────
var FILE_NAME      = 'ModelGroup.csv';   // CSV filename in Drive
...
function updateCatalogFromCsv() {
  ...
  dataRows.forEach(function(r,i){
    var key = r[headerIdx[KEY_COLUMN]];
  ...
  var csvAll = Utilities.parseCsv(files.next().getBlob().getDataAsString());
